...
<table border=0 width=100%>
  <tr>
    <td rowspan='2' width="50%" align="left"><?php if (trim($s['foto'])==''){
        echo "<img style='width:135px;  border:1px solid #000' src='../asset/foto_siswa/no-image.jpg'>";
      }else{
        echo "<img style='width:135px; padding:3px; border:1px solid #000' src='../asset/foto_siswa/$s[foto]'>";
      } ?></td>
