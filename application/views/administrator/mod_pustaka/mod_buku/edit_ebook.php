...
echo "<div class='col-md-12'>
  ...
  echo form_open_multipart($this->uri->segment(1).'/edit_ebook',$attributes); 
    echo "<div class='col-md-12'>
      ...
      <tbody>
        ...
        <tr><th scope='row'>Foto</th> <td><input type='file' class='form-control' name='foto' value='$s[foto]'required>";
        if ($s['foto']!=''){ echo "<small>Foto saat ini : <a href='foto_buku/$s[foto]'><i>$s[foto]</i></a></small>"; } echo "</td></tr>

        <tr><th scope='row'>Dokumen Ebook</th> <td><input type='file' class='form-control' name='dokumen' value='$s[file]' required>";
        if ($s['dokumen']!=''){ echo "<small>File : <a href='dokumen_ebook/$s[file]'><i>$s[file]</i></a></small>"; } echo "</td></tr>
  ...
  <div class='box-footer'>
        ...
        <a href='".base_url()."".$this->uri->segment(1)."/ebook'>
