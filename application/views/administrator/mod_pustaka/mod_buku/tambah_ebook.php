...
echo "<div class='col-md-12'>
  ...
  echo form_open_multipart($this->uri->segment(1).'/tambah_ebook',$attributes); 
    echo "<div class='col-md-12'>
      ...
      <tbody>
        ...
        <tr><th scope='row'>Upload Cover</th><td><input type='file' name='foto'><a></a>
        <tr><th scope='row'>Upload Dokumen E-Book</th><td><input type='file' name='dokumen'><a>Format file pdf, docx, doc.</a>
