            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  ...
                  <a class='pull-right btn btn-default btn-sm' style="margin-left: 20px" href='<?php echo base_url().$this->uri->segment(1); ?>/rak_buku'> Kembali </a>
                  <?php if ($_GET[id] != '') { ?>
                  <a class='pull-right btn btn-primary btn-sm' href='<?php echo base_url().$this->uri->segment(1).'/tambah_buku?id='."$_GET[id]"?>'>Tambahkan Data</a>
                  <?php } ?>
