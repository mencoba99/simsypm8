              ...
              echo form_open_multipart($this->uri->segment(1).'/edit_jadwal_pelajaran',$attributes); 
                echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Jadwal Paralel</th>  <td><input type='text' class='form-control' name='f' value='$s[paralel]'></td></tr>
                    <tr><th scope='row'>Jadwal Serial</th>  <td><input type='text' class='form-control' name='g' value='$s[jadwal_serial]'></td></tr>
