    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Link</th>                       <td><a>".base_url().$this->uri->segment(1)."/</a><input type='text' class='form-control' name='b' value='$rows[link]' style='width:50%; display:inline-block' required></td></tr>
