              ...
              echo form_open_multipart($this->uri->segment(1).'/tambah_suppliers',$attributes); 
                echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='120px' scope='row'>Kd Supplier</th> <td><input type='text' class='form-control' name='a'> </td></tr>     
                    <tr><th scope='row'>Nama Supplier</th>        <td><input type='text' class='form-control' name='b'></td></tr>
                    <tr><th scope='row'>Alamat Lengkap</th>        <td><textarea class='form-control' name='c'></textarea></td></tr>
                    <tr><th scope='row'>No Telpon</th>          <td><input type='number' class='form-control' name='d'></td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
