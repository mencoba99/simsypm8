              ...
              echo form_open_multipart($this->uri->segment(1).'/tambah_agenda',$attributes); 
                echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th width='30px' scope='row'>Tanggal Agenda</th> <td><input type='text' class='form-control datepicker' autocomplete='off' name='a'></td></tr>
                    ...
                    <tr><th width='120px'>Ketua Pelaksana</th><td>
                    <select class='form-control combobox' name='d' required>
