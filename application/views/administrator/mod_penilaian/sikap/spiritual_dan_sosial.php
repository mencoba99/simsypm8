                ...
                <table class='table table-condensed table-hover'>
                  <tbody>";
                        if ($_GET['kelas']!='' AND $_GET['tahun']!=''){
                          ...
                          echo "<tr><th width='130px' scope='row'>Tahun Akademik</th> <td><select name='tahun' style='padding:4px; width:300px'>
                                      <option value=''>- Pilih -</option>";
                                        foreach ($tahun as $k) {
                          ...
                          echo "</select></td></tr>
                                ...
                                <tr><th scope='row'>Sikap</th>                   <td><select name='sikap' style='padding:4px; width:300px'>
                                       <option value='spiritual'>Spiritual (KI.1)</option>
                                       <option value='sosial'>Sosial (KI.2)</option>
                                     </select>
