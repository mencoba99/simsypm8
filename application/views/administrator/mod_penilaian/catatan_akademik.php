            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Input Catatan Akademik </h3>
                </div>
                  <?php 
          echo "<div class='box-body'>";
              if($this->session->level!='guru'){
                echo "<form style='margin-right:5px; margin-top:0px' action='".base_url().$this->uri->segment(1)."/catatan_akademik' method='GET'>
                  ...
                  echo "<form action='".base_url().$this->uri->segment(1)."/catatan_akademik/".$this->uri->segment(3)."'' method='POST' class='form-horizontal' role='form'>
                  ...
                  if ($record->num_rows()<=0){
                    ...
                    $a = $this->model_app->view_where('rb_nilai_catatan_akademik',array('id_siswa'=>$r['id_siswa'],'id_tahun_akademik'=>$this->input->get('tahun')))->row_array();
                    echo "<tr><td>$no</td>
                          <td>$r[nisn]</td>
                          <td>$r[nama]</td>
