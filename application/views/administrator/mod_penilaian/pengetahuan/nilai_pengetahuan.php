            <div class="col-xs-12">  
              <div class="box">
                ...
                <div class="box-body">
                <?php 
                  echo "<form style='margin-right:5px; margin-top:0px' action='".base_url().$this->uri->segment(1)."/nilai_pengetahuan' method='GET'>
                ...
                ?>
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$r[nama_kelas]</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='List Bahan dan Tugas' href='".base_url().$this->uri->segment(1)."/detail_nilai_pengetahuan/$r[kodejdwl]'><span class='glyphicon glyphicon-th'></span> Input Nilai</a>
                              </center></td>
                              </tr>";
                      $no++;
                      }
