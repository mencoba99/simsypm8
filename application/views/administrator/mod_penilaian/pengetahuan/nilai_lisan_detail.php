    ...
    echo "<div class='col-md-12'>
            ...
            <div class='panel-body'>
              <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                <li role='presentation' class='active'><a href='#lisan' id='lisan-tab' role='tab' data-toggle='tab' aria-controls='lisan' aria-expanded='true'>Nilai Lisan KD $row[kd]</a></li>
                <li role='presentation' class=''><a href='#rekap' role='tab' id='rekap-tab' data-toggle='tab' aria-controls='rekap' aria-expanded='false'>Rekap Nilai Lisan  KD $row[kd]</a></li>
              </ul><br>
