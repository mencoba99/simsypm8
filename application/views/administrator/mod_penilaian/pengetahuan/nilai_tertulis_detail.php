    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Input Nilai Pengetahuan Tertulis</h3>
                </div>
              <div class='box-body'>
            <form action='".base_url().$this->uri->segment(1)."/detail_nilai_tertulis/".$this->uri->segment(3)."'' method='GET' class='form-horizontal' role='form'>
            ...
            <div class='panel-body'>
              <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                <li role='presentation' class='active'><a href='#tertulis' id='tertulis-tab' role='tab' data-toggle='tab' aria-controls='tertulis' aria-expanded='true'>Nilai Tertulis KD $row[kd]</a></li>
                <li role='presentation' class=''><a href='#rekap' role='tab' id='rekap-tab' data-toggle='tab' aria-controls='rekap' aria-expanded='false'>Rekap Nilai Tertulis  KD $row[kd]</a></li>
              </ul><br>
            <div id='myTabContent' class='tab-content'>
            <div role='tabpanel' class='tab-pane fade active in' id='tertulis' aria-labelledby='tertulis-tab'>
               <div class='col-md-12'>";
              $attributes = array('class'=>'form-horizontal','role'=>'form');
              echo form_open_multipart($this->uri->segment(1).'/detail_nilai_tertulis/'.$this->uri->segment(3),$attributes); 
              ...
              echo "<table class='table table-bordered table-striped'>
                <thead>
                      <tr style='background:#e3e3e3;'>
                        ...
                        <th>NISN</th>
                        <th>Nama Siswa</th>
                        <th><center>Nilai Tes Tertulis</center></th>
                      </tr>
                    </thead>
                    <tbody>";
               ...
               <table class='table table-bordered table-striped'>
                <thead>
                      <tr style='background:#e3e3e3;'>
                        ...
                        <th>NISN</th>
                        <th>Nama Siswa</th>
                        <th><center>Nilai Tertulis</center></th>
                        <th>Rata-rata</th>
                      </tr>
                    </thead>
                    <tbody>";
                  if ($this->input->get('tanggal')!=''){
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$r[nisn]</td>
                              <td>$r[nama]</td>
                              <td><a data-toggle='tooltip' data-placement='right' title='$aa[tanggal_nilai_tertulis]' href=''>$aa[nilai_tertulis]</a></td>
