            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Input Nilai UHB (Ulangan Harian Bersama)</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                <?php 
                  echo "<form style='margin-right:5px; margin-top:0px' action='".base_url().$this->uri->segment(1)."/nilai_uts_kd' method='GET'>
                ...
                ?>
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$r[nama_kelas]</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='List Bahan dan Tugas' href='".base_url().$this->uri->segment(1)."/detail_nilai_uhb/$r[kodejdwl]'><span class='glyphicon glyphicon-th'></span> Input Nilai</a>
                              </center></td>
                              </tr>";
                      $no++;
                      }
