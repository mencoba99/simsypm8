    ...
    echo "<div class='col-md-12'>
            ...
            <div class='panel-body'>
              <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                <li role='presentation' class='active'><a href='#semester' id='semester-tab' role='tab' data-toggle='tab' aria-controls='semester' aria-expanded='true'>Nilai Akhir Semester</a></li>
              ...
              echo "<table class='table table-bordered table-striped'>
                <thead>
                  ...
                  if ($this->input->get('tanggal')!=''){
                    ...
                    foreach ($siswa as $r) {
                    $a = $this->db->query("SELECT a.* FROM rb_nilai_pengetahuan a JOIN rb_jadwal_pelajaran b ON a.kodejdwl=b.kodejdwl where a.id_siswa='$r[id_siswa]' AND b.id_mata_pelajaran='$s[id_mata_pelajaran]' AND a.kategori_nilai='3' AND b.id_tahun_akademik='$s[id_tahun_akademik]'")->row_array();
                    echo "<tr><td>$no</td>
                              <td>$r[nipd]</td>
                              <td>$r[nisn]</td>
                              <td>$r[nama]</td>
