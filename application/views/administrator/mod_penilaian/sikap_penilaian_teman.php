            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Penilaian Teman </h3>
                </div>
                <?php
          echo "<div class='box-body'>
                <form style='margin-right:5px; margin-top:0px' action='".base_url()."".$this->uri->segment(1)."/sikap_penilaian_teman' method='GET'>
              ...
              <table class='table table-bordered table-striped'>
                  ...
                  if ($record->num_rows()<=0){
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Penilaian Diri' href='".base_url().$this->uri->segment(1)."/penilaian_teman_siswa/$r[id_siswa]?tahun=$_GET[tahun]'><span class='glyphicon glyphicon-th-list'></span> Detail</a>
                              </center></td>
                              </tr>";
                      $no++;
                      }
