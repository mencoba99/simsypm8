<?php
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->uri->segment(1).'/tambah_deskripsi_penilaian_sikap',$attributes); 
                echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id' value=''>
                    <tr><th width='120px' scope='row'>Deskripsi Sikap</th> <td><textarea class='form-control' name='a'></textarea></td></tr>
