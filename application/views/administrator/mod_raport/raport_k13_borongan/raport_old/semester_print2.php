...
echo "<b>A. Nilai Akademik</b>
        <table id='tablemodul1' width=100% border=1>
          <tr>
            <th width='30px'>No</th>
            <th width='160px'>Mata Pelajaran</th>
            <th>Pengetahuan</th>
            <th>Keterampilan</th>
            <th>Nilai Akhir</th>
            <th>Predikat</th>
    ...
    if ($sub_kelompok->num_rows()>=1){
      ...
      echo "<tr>
        ...
        foreach ($mapel->result_array() as $m) {                              
          ...
          $nilai_raport = ($a['nilai_pengetahuan']+$a['nilai_keterampilan'])/2;
          ...
          echo "<tr>
                  ...
                  <td valign=top align=center>".number_format($a['nilai_pengetahuan'])." </td>
                  <td valign=top align=center>".number_format($a['nilai_keterampilan'])."</td>
