...
echo "<b>G. Catatan Perkembangan Karakter</b>
      <table id='tablemodul1' width=100% style='min-height:50px' border=1>
        <tr><td>$ctt[deskripsi] </td></tr>
      </table>";
      
if (substr($t['kode_tahun_akademik'],4,5)=='2'){      
    $ex = explode('.',$s['kode_kelas']);
    if ($ex[0]=='X'){ $kelas_naik = 'XI'; }
    elseif ($ex[0]=='XI'){ $kelas_naik = 'XII'; }
    echo "<br><b>H. Kenaikan Kelas</b>
          <table id='tablemodul1' width=100% style='min-height:50px' border=1>
            <tr><td>Naik / Tidak Naik ke Kelas $kelas_naik</td></tr>
          </table>";
}
...
<table style='margin-top:7px' border=0 width=90%>
  <tr>
    ...
    <td width="500"align="center"><br><br><br><br><br></td>
  ...
  <tr>
    <td valign=top align="left">
      ...
      if ($s['rapor_sms']=='0'){
        echo $s['nama_ibu']; 
      }elseif ($s['rapor_sms']=='1'){
         echo $s['nama_ayah'];  
      }elseif ($s['rapor_sms']=='2'){
         echo $s['nama_wali'];  
      }else{
         echo ''; 
      } */
    ...
    <td align="center" valign="top"><br>
      ...
      <b><?php echo $kepsek['nama_lengkap']; ?><br></b> NIP. <?php echo $kepsek['nip']; ?>
    </td>

    <td valign=top align="left" valign="top">
      <b><?php echo $s['wali_kelas']; ?><br></b> NIP. <?php echo $s['nip']; ?>
    </td>
  </tr>
</table> 
</center>
<div style='right:0; bottom:0px; position:absolute;'>2 dari 2</div>
</body>
</html>
