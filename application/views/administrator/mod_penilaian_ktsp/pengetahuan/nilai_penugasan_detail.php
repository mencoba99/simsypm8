    ...
    echo "<div class='col-md-12'>
            ...
            <div class='panel-body'>
              <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                <li role='presentation' class='active'><a href='#penugasan' id='penugasan-tab' role='tab' data-toggle='tab' aria-controls='penugasan' aria-expanded='true'>Nilai Tes Penugasan KD $row[kd]</a></li>
