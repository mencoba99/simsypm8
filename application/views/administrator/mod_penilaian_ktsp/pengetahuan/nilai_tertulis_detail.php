    ...
    echo "<div class='col-md-12'>
            ...
            <div class='panel-body'>
              <ul id='myTabs' class='nav nav-tabs' role='tablist'>
                <li role='presentation' class='active'><a href='#tertulis' id='tertulis-tab' role='tab' data-toggle='tab' aria-controls='tertulis' aria-expanded='true'>Nilai Tes Tertulis KD $row[kd]</a></li>
