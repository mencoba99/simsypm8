...
<?php
      if (isset($_POST['simpan'])){
        mysqli_query($koneksi,"INSERT INTO rb_nilai_remedial_pengetahuan VALUES('','$_GET[id]','$_POST[tahun]','$_POST[kodejdwl]','$_POST[nisn]','$_POST[kd]','$_POST[rata_rata]','$_POST[nilai_remedial]','N','$_POST[waktu]')");
            ...
            echo "<div class='col-xs-12'>  
              <div class='box'>
                <div class='box-header'>
                  <h5 class='box-title alert alert-success'><b>Data Nilai Remedial Pengetahuan</b> </h5>
                </div>
                <div class='box-body'>
                  <div class='col-md-12'>";
                  $attributes = array('class'=>'form-horizontal','role'=>'form');
                  echo form_open_multipart($this->uri->segment(1).'/remedial_pengetahuan?kodejdwl='.$this->input->get('kodejdwl').'&kd='.$this->input->get('kd').'&siswa='.$this->input->get('siswa').'',$attributes); 
                  ...
                  <table id='example1' class='table table-striped table-condensed'>
                    ...
                    <tbody>";
                    $no = 1;
                    $tampil = $this->model_app->view_where('rb_nilai_remedial_pengetahuan',array('kodejdwl'=>$this->input->get('kodejdwl'), 'id_kompetensi_dasar'=>$this->input->get('kd'), 'id_siswa'=>$this->input->get('siswa')));
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>
                                <a class='btn btn-danger btn-xs' style='width:55px' title='Delete Data' href='".base_url().$this->uri->segment(1)."/delete_remedial_pengetahuan?kodejdwl=".$this->input->get('kodejdwl')."&kd=".$this->input->get('kd')."&siswa=".$this->input->get('siswa')."&id=$r[id_nilai_remedial_pengetahuan]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </td>
                          </tr>";
                      $no++;
                      }
