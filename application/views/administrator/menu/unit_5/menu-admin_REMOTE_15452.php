          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <?php
                ...
                //         </a>
                //         <ul class='treeview-menu'>
                //           <li><a href='".base_url()."$sekolah[keyword]/labor_kasus'><i class='fa fa-circle-o'></i> Data Alat Pecah</a></li>
                //           <li><a href='".base_url()."$sekolah[keyword]/laporan_laboratorium'><i class='fa fa-circle-o'></i> Laporan Alat Pecah</a></li>
                //         </ul>
                //       </li>";
                // }
                ...
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li class='treeview'>
                        <a href='#'><i class='fa fa-circle-o'></i> Humas<i class='fa fa-angle-left pull-right'></i></a>
                        <ul class='treeview-menu'>
                          <li><a href='".base_url()."$sekolah[keyword]/tracer_alumni'><i class='fa fa-circle-o'></i> Tracer Alumni</a></li>
                          </ul>
                          </li>";
                        }
                        ?>
...
=======
             <!--  <?php 
              ...
              <li class="treeview">
>>>>>>> 8dc54df7c45d65c08d36ce95324868d017383cd8
              ...
              <?php
                ...
                $cek=$this->model_app->umenu_akses("transaksi_koperasi",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
                  echo "<li><a href='".base_url()."keuangan/transaksi_koperasi'><i class='fa fa-circle-o'></i> Transaksi Koperasi</a></li>";
                }
            ...
            <li class="treeview">
              <a href="#"><i class="fa fa-building"></i> <span>Bursa Kerja Khusus (BKK)</span><i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
              <!-- <?php
                $cek=$this->model_app->umenu_akses("suppliers",$this->session->id_session);
                if($cek==1 OR $this->session->level=='admin'){
