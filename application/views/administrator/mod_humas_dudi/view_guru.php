            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Tracer Study Pegawai </h3>
                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                <a class='btn btn-primary btn-xs' title='Lihat Data' href='".base_url().$this->uri->segment(1)."/detail_tracer_alumni/$r[id_traceralumni]'><span class='glyphicon glyphicon-eye-open'></span></a>
