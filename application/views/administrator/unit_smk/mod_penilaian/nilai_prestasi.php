                  ...
                  echo "<table id='example' class='table table-bordered table-striped'>
                    <thead>
                      <tr><th rowspan='2'>No</th>
                        <th>NISN</th>
                        <th>Nama Siswa</th>
                        <th style='max-width:270px; min-width:150px'><center>Prestasi</center></th>
                      ...
                      if ($_GET['id_siswa']==$r['id_siswa']){  
                        echo "<form action='".base_url().$this->uri->segment(1)."/nilai_prestasi?tahun=$_GET[tahun]&kelas=$_GET[kelas]' method='POST'>
                                <tr><td>$no</td>
                                  ...
                                  <td><input type='text' name='a' class='form-control' style='width:100%; color:blue' placeholder='Tuliskan Prestasi...' value='$e[jenis_kegiatan]'></td>
                                  <td><textarea name='b' class='form-control' style='width:100%; height:32px;' placeholder=' Tuliskan Keterangan...' onkeyup=\"auto_grow(this)\">$e[keterangan]</textarea></td>
                        ...
                        echo "<form action='".base_url().$this->uri->segment(1)."/nilai_prestasi?tahun=$_GET[tahun]&kelas=$_GET[kelas]' method='POST'>
                                <tr><td>$no</td>
                                  ...
                                  <input type='hidden' name='id_siswa' value='$r[id_siswa]'>
                                  <input type='hidden' name='status' value='$name'>
                                  <td><input type='text' name='a' class='form-control' style='width:100%; color:blue' placeholder='Tuliskan Prestasi...'></td>
                                  <td><textarea name='b' class='form-control' style='width:100%; height:32px;' placeholder=' Tuliskan Keterangan...' onkeyup=\"auto_grow(this)\"></textarea></td>
                                  <td align=center><input type='submit' name='simpan' class='btn btn-xs btn-primary' style='width:65px' value='$name'></td>
                                </tr>
                              </form>";
                      }
