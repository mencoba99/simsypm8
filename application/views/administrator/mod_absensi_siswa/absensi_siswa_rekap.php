    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  ...
                  <a class='pull-right btn btn-warning btn-sm' href='".base_url().$this->uri->segment(1)."/absensi_siswa'>Kembali</a>
                  <a target='_BLANK' style='margin-right:5px' class='pull-right btn btn-success btn-sm' href='".base_url().$this->uri->segment(1)."/rekap_absensi_siswa_print/".$this->uri->segment(3)."'><span class='glyphicon glyphicon-print'></span> Print</a>
                </div>
              <div class='box-body'>
