<?php
    echo "<div class='col-md-12'>
              ...
              echo form_open_multipart($this->uri->segment(1).'/tambah_predikat_jadwal_pelajaran/'.$this->uri->segment(3),$attributes); 
                echo "<div class='col-md-12'>
                  <table class='table table-condensed table-bordered'>
                  <tbody>
                    <input type='hidden' name='id_mata_pelajaran' value='".$this->uri->segment(3)."'>
              ...
              <div class='box-footer'>
                    ...
                    <a href='".base_url()."".$this->uri->segment(1)."/predikat_jadwal_pelajaran/".$this->uri->segment(3)."'><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
              </div>";
              echo form_close();
            echo "</div>";
