    ...
    echo "<div class='col-md-12'>
            <div class='box box-info'>
                ...
                <div class='box-body'>";
                    ...
                    echo form_open_multipart($this->uri->segment(1).'/edit_pengumuman/'.$this->uri->segment(3),$attributes); 
                    echo "<div class='col-md-12'>
                        <table class='table table-condensed table-bordered table-condensed'>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input autocomplete='off' type='text' class='form-control' name='a' value='$s[judul]'></td>
                                </tr>
